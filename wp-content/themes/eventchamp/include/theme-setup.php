...
if( !function_exists( 'eventchamp_admin_scripts' ) ) {
	...
	function eventchamp_admin_scripts() {
		...
		if( is_admin() ) {
			...
			wp_enqueue_style( 'eventchamp-ot-admin', get_template_directory_uri() . '/include/admin/assets/css/ot-admin.css' , array( 'ot-admin-css' ) );
	...
	add_action( 'admin_enqueue_scripts', 'eventchamp_admin_scripts', 96999999 );
